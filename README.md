...
<p align="center">
这个插件能够帮到你方便查看和编写 <a href="https://github.com/i18next/react-i18n-assistantext">i18next</a> 🎉
</p>
...
在 `vscode` 插件里搜索 `react-i18n-assistant`，或者点击上上方的小徽章安装吧！
